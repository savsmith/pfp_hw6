...
bool graph::construct_from_dimacs(const std::string dimacs_name) {
  ...
  name = dimacs_name.substr(dimacs_name.find("/") + 1);
...
string graph::getGraphType() {
  if (name.compare("roadFLA.dimacs") == 0) {
    //cout << "Graph Type: roadFLA" << endl;
    return "roadFLA";
  } else if (name.compare("roadNY.dimacs") == 0) {
    //cout << "Graph Type: roadNY" << endl;
    return "roadNY";
  } else if (name.substr(0,4).compare("rmat") == 0) {
    //cout << "Graph Type: rmat" << endl;
    return "rmat";
  } else {
    //cout << "Graph Type: other" << endl;
    return "other";
  }
}
